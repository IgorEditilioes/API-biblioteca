# Generated by Django 5.2.7 on 2025-10-11 01:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('bibliotecario', 'Bibliotecário'), ('aluno', 'Aluno'), ('visitante', 'Visitante')], default='visitante', max_length=20)),
